...
The easiest way to create a new Next.js app with Contentlayer is by using [offical Next.js example](https://github.com/vercel/next.js/tree/canary/examples/with-contentlayer),
...
which you will add this lines of code to.
