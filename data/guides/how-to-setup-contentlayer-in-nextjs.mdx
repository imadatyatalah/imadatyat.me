...
The easiest way create a new Next.js app with Contentlayer is by usign [offical Next.js example](https://github.com/vercel/next.js/tree/canary/examples/with-contentlayer),
